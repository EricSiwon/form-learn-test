...
import DisplayCodePrism from "./DisplayCodePrism";

import "./FormikYupMaterialCustomForm.css";
...
import {
  MuiThemeProvider, // cree un theme
  createMuiTheme,
  withStyles,
  makeStyles
...
export default function FormikYupMaterialCustomForm() {
  ...
  return (
    <>
      ...
      <hr />
      <h1>Formik + Yup + Custom Material-UI</h1>
